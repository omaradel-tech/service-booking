    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="bookings">
                    <a href="#bookings">Bookings</a>
                                    ...
                                    <ul id="tocify-subheader-bookings" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="bookings-GETapi-v1-bookings">
                                <a href="#bookings-GETapi-v1-bookings">List user bookings</a>
                            </li>
                                ...
                                <a href="#bookings-GETapi-v1-bookings--id-">Get booking details</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="bookings-PATCHapi-v1-bookings--id--cancel">
                                <a href="#bookings-PATCHapi-v1-bookings--id--cancel">Cancel a booking</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="cart">
                    <a href="#cart">Cart</a>
                                ...
                                <a href="#cart-GETapi-v1-cart">Get user's cart</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="cart-POSTapi-v1-cart-items">
                                <a href="#cart-POSTapi-v1-cart-items">Add item to cart</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="cart-PATCHapi-v1-cart-items--id-">
                                <a href="#cart-PATCHapi-v1-cart-items--id-">Update cart item quantity</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="cart-DELETEapi-v1-cart-items--id-">
                                <a href="#cart-DELETEapi-v1-cart-items--id-">Remove item from cart</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="packages">
                    <a href="#packages">Packages</a>
                                    ...
                                    <ul id="tocify-subheader-packages" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="packages-GETapi-v1-packages">
                                <a href="#packages-GETapi-v1-packages">List all active packages</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="packages-GETapi-v1-packages--id-">
                                <a href="#packages-GETapi-v1-packages--id-">Get package details</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="services">
                    <a href="#services">Services</a>
                                ...
                                <a href="#services-GETapi-v1-services">List all active services</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="services-GETapi-v1-services--id-">
                                <a href="#services-GETapi-v1-services--id-">Get service details</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="subscriptions">
                    <a href="#subscriptions">Subscriptions</a>
                                    ...
                                    <ul id="tocify-subheader-subscriptions" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="subscriptions-GETapi-v1-subscriptions-current">
                                <a href="#subscriptions-GETapi-v1-subscriptions-current">Get current subscription</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
    ...
    <p>Authentication endpoints for user registration, login, and profile management.</p>
...
<p>Creates a new user account and automatically creates a trial subscription.</p>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Booking management endpoints for scheduling and managing service appointments.</p>

                                <h2 id="bookings-GETapi-v1-bookings">List user bookings</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns all bookings for the authenticated user.</p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-bookings"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<p>Creates a new booking for a service at the specified time.</p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               step="any"               name="service_id"                data-endpoint="POSTapi-v1-bookings"
               value="16"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="scheduled_at"                data-endpoint="POSTapi-v1-bookings"
               value="2052-05-15"
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>now</code>. Example: <code>2052-05-15</code></p>
        </div>
        </form>

                    <h2 id="bookings-GETapi-v1-bookings--id-">Get booking details</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns detailed information about a specific booking.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/bookings/1" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/v1/bookings/1"
);
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>Booking ID. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="bookings-PATCHapi-v1-bookings--id--cancel">Cancel a booking</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Cancels a booking if it can be canceled (pending or confirmed status and future time).</p>

<span id="example-requests-PATCHapi-v1-bookings--id--cancel">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://127.0.0.1:8000/api/v1/bookings/1/cancel" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-PATCHapi-v1-bookings--id--cancel">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PATCHapi-v1-bookings--id--cancel" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-v1-bookings--id--cancel"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-v1-bookings--id--cancel"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-v1-bookings--id--cancel" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-v1-bookings--id--cancel">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-v1-bookings--id--cancel" data-method="PATCH"
      data-path="api/v1/bookings/{id}/cancel"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-v1-bookings--id--cancel', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-v1-bookings--id--cancel"
                    onclick="tryItOut('PATCHapi-v1-bookings--id--cancel');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-bookings--id--cancel"
                    onclick="cancelTryOut('PATCHapi-v1-bookings--id--cancel');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-v1-bookings--id--cancel"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <b><code>api/v1/bookings/{id}/cancel</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PATCHapi-v1-bookings--id--cancel"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-v1-bookings--id--cancel"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-v1-bookings--id--cancel"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PATCHapi-v1-bookings--id--cancel"
               value="1"
               data-component="url">
    <br>
<p>Booking ID. Example: <code>1</code></p>
    ...
    <p>Cart management endpoints for adding, updating, and removing items from the shopping cart.</p>

                                <h2 id="cart-GETapi-v1-cart">Get user&#039;s cart</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns the authenticated user's shopping cart with all items.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="cart-POSTapi-v1-cart-items">Add item to cart</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Adds a service or package to the user's cart.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="item_type"                data-endpoint="POSTapi-v1-cart-items"
               value="service"
               data-component="body">
    <br>
<p>Example: <code>service</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>service</code></li> <li><code>package</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="item_id"                data-endpoint="POSTapi-v1-cart-items"
               value="16"
               data-component="body">
    <br>
...
<p>Must be at least 1. Must not be greater than 10. Example: <code>2</code></p>
                    ...
                    <h2 id="cart-PATCHapi-v1-cart-items--id-">Update cart item quantity</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Updates the quantity of an existing cart item.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://127.0.0.1:8000/api/v1/cart/items/1" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PATCHapi-v1-cart-items--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PATCHapi-v1-cart-items--id-"
               value="1"
               data-component="url">
    <br>
...
<p>Must be at least 1. Must not be greater than 10. Example: <code>6</code></p>
                    ...
                    <h2 id="cart-DELETEapi-v1-cart-items--id-">Remove item from cart</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Removes an item from the user's cart.</p>
...
<p>Cart item ID. Example: <code>1</code></p>
    ...
    <p>Package management endpoints for browsing service bundles.</p>

                                <h2 id="packages-GETapi-v1-packages">List all active packages</h2>

<p>
</p>

<p>Returns a list of all currently active service packages with their included services.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/packages" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="packages-GETapi-v1-packages--id-">Get package details</h2>

<p>
</p>

<p>Returns detailed information about a specific package including all included services.</p>

<span id="example-requests-GETapi-v1-packages--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/packages/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/v1/packages/1"
);
...
<span id="example-responses-GETapi-v1-packages--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-packages--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-packages--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-packages--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-packages--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-packages--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-packages--id-" data-method="GET"
      data-path="api/v1/packages/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-packages--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-packages--id-"
                    onclick="tryItOut('GETapi-v1-packages--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-packages--id-"
                    onclick="cancelTryOut('GETapi-v1-packages--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-packages--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-packages--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-packages--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-v1-packages--id-"
               value="1"
               data-component="url">
    <br>
<p>Package ID. Example: <code>1</code></p>
    ...
    <p>Service management endpoints for browsing available maintenance services.</p>

                                <h2 id="services-GETapi-v1-services">List all active services</h2>

<p>
</p>

<p>Returns a list of all currently active maintenance services.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="services-GETapi-v1-services--id-">Get service details</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/services/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Service ID. Example: <code>1</code></p>
    ...
    <p>Subscription management endpoints for viewing and managing user subscriptions.</p>

                                <h2 id="subscriptions-GETapi-v1-subscriptions-current">Get current subscription</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns the authenticated user's current active subscription.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/subscriptions/current" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/v1/subscriptions/current"
);
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-subscriptions-current"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
